                                ...
                                {filtrarProdutos().map((produto) => (
                                    <tr class='Conteudo'>
                                        ...
                                        <td class="final"><button onClick={vizualizarproduto}><svg width="40" height="40"
                                            ...
                                            <path
                                                d="M18.3335 15H21.6668V11.6667H18.3335M20.0002 33.3333C12.6502 33.3333 6.66683 27.35 6.66683 20C6.66683 12.65 12.6502 6.66667 20.0002 6.66667C27.3502 6.66667 33.3335 12.65 33.3335 20C33.3335 27.35 27.3502 33.3333 20.0002 33.3333ZM20.0002 3.33333C17.8115 3.33333 15.6442 3.76443 13.6221 4.60201C11.6 5.43958 9.76269 6.66724 8.21505 8.21489C5.08944 11.3405 3.3335 15.5797 3.3335 20C3.3335 24.4203 5.08944 28.6595 8.21505 31.7851C9.76269 33.3328 11.6 34.5604 13.6221 35.398C15.6442 36.2356 17.8115 36.6667 20.0002 36.6667C24.4204 36.6667 28.6597 34.9107 31.7853 31.7851C34.9109 28.6595 36.6668 24.4203 36.6668 20C36.6668 17.8113 36.2357 15.644 35.3982 13.6219C34.5606 11.5998 33.3329 9.76253 31.7853 8.21489C30.2376 6.66724 28.4003 5.43958 26.3782 4.60201C24.3561 3.76443 22.1889 3.33333 20.0002 3.33333ZM18.3335 28.3333H21.6668V18.3333H18.3335V28.3333Z"
                                                fill="black" />
                                            <path
